---
title: Error codes used by Bing News Search APIs
titleSuffix: Bing Services
description: Provides the list of HTTP status codes and service error codes that Bing News Search may return.
author: alekhyasasi
manager: ehansen
...
# HTTP status codes that Bing News Search APIs may return
