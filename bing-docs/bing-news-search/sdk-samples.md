---
title: Bing News Search SDK samples
titleSuffix: Bing Search Services
description: Use the Bing News Search SDK to learn how to search the web for news articles.
...
# Bing News Search SDK samples

The Bing News Search SDK is available in Python, Node.js, C#, and Java. You can use the SDK to search the web for news articles. Code samples, prerequisites, and build instructions are provided on GitHub. 
