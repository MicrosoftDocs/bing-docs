---
title: Market and language codes used by the Bing Entity Search API
titleSuffix: Bing Services
description: Provides the list of markets and languages that you may specify in Bing Entity Search requests.
author: swhite-msft
manager: ehansen
...
# Market and language codes used by Bing Entity Search API
