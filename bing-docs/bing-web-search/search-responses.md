...
A unit conversion query is a query that converts one unit to another. For example, _How many feet in 10 meters?_ or _How many tablespoons in a 1/4 cup?_

The following shows the `computation` answer for _How many feet in 10 meters?_
