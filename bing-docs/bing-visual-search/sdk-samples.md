---
title: Bing Visual Search SDK samples
titleSuffix: Bing Search Services
description: Use the Bing Visual Search SDK to get insights about an image.
...
# Bing Visual Search SDK samples

The Bing Visual Search SDK is available in Python, Node.js, C#, and Java. You can use the SDK to get insights about an image. Code samples, prerequisites, and build instructions are provided on GitHub. 
