...
Initial release of this version of Bing Custom Web Search API. This API replaces the same API hosted by [Azure Cognitive Services](https://docs.microsoft.com/azure/cognitive-services/bing-custom-search/), which is being phased out.
