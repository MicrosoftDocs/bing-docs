---
title: Error codes used by Bing Custom Image Search API
titleSuffix: Bing Services
description: Provides the list of HTTP status codes and service error codes that Bing Custom Image Search may return.
author: swhite-msft
manager: ehansen
...
# HTTP status codes that Bing Custom Image Search API may return
