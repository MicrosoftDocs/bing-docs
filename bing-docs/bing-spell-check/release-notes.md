...
To subscribe to a package that includes this API, see [Get a subscription key](../bing-web-search/get-subscription-key.md). Next, get familiar with the [Spell Check API](overview.md) documentation, and be sure to check out the [quickstarts](quickstarts/quickstarts.md) to get up and running quickly.
