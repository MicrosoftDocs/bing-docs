...
|readLink|A URL that you'd use to request images from Image Search API. The URL is not well formed; you need to prefix the URL with `https://api.bing.microsoft.com/v7.0` to create a well-formed URL. Include other query parameters as needed.|String 
