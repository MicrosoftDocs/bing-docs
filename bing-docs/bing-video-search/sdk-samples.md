---
title: Bing Video Search SDK samples
titleSuffix: Bing Search Services
description: Use the Bing Video Search SDK to search the web for videos.
...
The Bing Video Search SDK is available in Python, Node.js, C#, and Java. You can use the SDK to search the web for videos. Code samples, prerequisites, and build instructions are provided on GitHub. 
