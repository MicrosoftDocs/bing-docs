...
Initial release of this version of Bing Video Search APIs. These APIs replace the same APIs hosted by <a href="https://learn.microsoft.com/azure/cognitive-services/bing-video-search/" target="_blank">Azure Cognitive Services</a>, which are being phased out.

### New to Bing Search?

To subscribe to a package that includes this API, see [Create Bing Search Service resource](../bing-web-search/create-bing-search-service-resource.md). Next, get familiar with the [Video Search API](overview.md) documentation.
